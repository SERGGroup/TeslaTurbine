...
for i in tqdm(range(len(dv_perc))):
    ...
    Eta_nometa[i] = tesla_turbine1.Eta_tesla_ss
    Eta_nometa_I[i] = tesla_turbine1.Eta_tesla_ss_dh
...
for i in tqdm(range(len(dv_perc))):
    ...
    Eta_meta[i] = tesla_turbine2.Eta_tesla_ss
    Eta_meta_I[i] = tesla_turbine2.Eta_tesla_ss_dh
    ...
    if tesla_turbine2.Eta_tesla_ss > 1:
        break
...
ax2.plot(Eta_nometa, Eta_nometa_I, c='darkblue', label='No-Meta')
ax2.plot(Eta_meta, Eta_meta_I, c='darkred', label='Meta')
...
print(tesla_turbine2.isentropic_outlet.get_variable('s'))
print(tesla_turbine2.isentropic_outlet.get_variable('h'))
