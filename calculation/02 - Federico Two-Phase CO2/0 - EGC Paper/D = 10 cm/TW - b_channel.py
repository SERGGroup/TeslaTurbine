...
res2 = output_array[:, 5].reshape(TW.shape)
res3 = ((output_array[:, 3] * output_array[:, 6]) / (output_array[:, 12] * 100000)).reshape(TW.shape)
res4 = (output_array[:, 7] / 1000000).reshape(TW.shape)
