...
from main_code.simplified_classes.simplified_rotor import SimplifiedRotor
...
curr_options.rotor.n_rotor = 1000
...
tt = BaseTeslaTurbine("Carbon Dioxide", curr_geometry, curr_options, stator=SPStatorMil, rotor=SimplifiedRotor)
...
tt.geometry.disc_thickness = 0.00005
tt.geometry.rotor.n_discs = 37
tt.geometry.H_s = 0.0045
