...
curr_options.rotor.n_rotor = 500
...
ax1.plot(rotor_array[:, 1], rotor_array[:, 11], label="Pressure", c='Darkblue')
ax1.grid()
ax1.set_title('Pressure')
ax1.set_xlabel('Radial Distance [m]')
ax1.set_ylabel('Pressure [Pa]')

ax2.plot(rotor_array[:, 1], rotor_array[:, 3], label="Velocity", c='Darkblue')
ax2.grid()
ax2.set_title('Velocity')
ax2.set_xlabel('Radial Distance [m]')
ax2.set_ylabel('Velocity [m/s]')

ax3.plot(rotor_array[:, 1], rotor_array[:, 13], label="Temperature", c='Darkblue')
ax3.grid()
