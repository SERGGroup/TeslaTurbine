...
plt.plot(disk_gap, CFD_torque,label='CFD Model', linestyle='', marker='D', mec='black', mfc='white', markersize = 8)
plt.plot(disk_gap, PY_torque, label='This Work', linestyle='', marker='^', mec='navy', mfc='navy', markersize = 8)

plt.xlim(0.2, 1.6)
plt.ylim(0.002, 0.012)
plt.xlabel('Disk Gap [mm]', fontsize=14)
